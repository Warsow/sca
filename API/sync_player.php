<?php
    if(isset($_POST))
    {
        ...
        LG_Shots = ?, LG_Hits = ?,
        EB_Shots = ?, EB_Hits = ?
        WHERE player_clean = ? AND account = ''";
        ...
        $eb_shots = $player->eb_shots; $eb_hits = $player->eb_hits;
         ...
         $statement->bind_param("siiiiiiiiidiiiiiiiiiiiiiiiis", $name, $score, $frags, $deaths, $suicides, $dmg_given, $dmg_received, $games, $rounds, $mvp, $playtime, $gb_shots, $gb_hits, $mg_shots, $mg_hits, $rg_shots, $rg_hits, $gl_shots, $gl_hits, $rl_shots, $rl_hits, $pg_shots, $pg_hits, $lg_shots, $lg_hits, $eb_shots, $eb_hits, $name_clean);
